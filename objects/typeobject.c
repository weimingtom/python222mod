...
static PyObject *type_name(PyTypeObject *type, void *context)
{
	char *s;
...
static PyObject *type_module(PyTypeObject *type, void *context)
{
	PyObject *mod;
	char *s;
...
static PyObject *type_get_doc(PyTypeObject *type, void *context)
{
	PyObject *result;
...
static int call_finalizer(PyObject *self)
{
...
static PyObject *lookup_maybe(PyObject *self, char *attrstr, PyObject **attrobj)
{
	PyObject *res;
...
static PyObject *lookup_method(PyObject *self, char *attrstr, PyObject **attrobj)
{
...
static PyObject *call_method(PyObject *o, char *name, PyObject **nameobj, char *format, ...)
{
	va_list va;
...
static PyObject *call_maybe(PyObject *o, char *name, PyObject **nameobj, char *format, ...)
{
	va_list va;
	PyObject *args, *func = 0, *retval;
	va_start(va, format);
...
static int conservative_merge(PyObject *left, PyObject *right)
{
	int left_size;
	int right_size;
	int i, j, r, ok;
...
static int serious_order_disagreements(PyObject *left, PyObject *right)
{
	return 0;
}
...
static PyObject *mro_external(PyObject *self)
{
...
static PyObject *bozo_func(PyObject *self, PyObject *args)
{
	PyErr_SetString(PyExc_TypeError,
...
static PyObject *type_subclasses(PyTypeObject *type, PyObject *args_ignored)
{
...
static PyObject *object_get_class(PyObject *self, void *closure)
{
...
static int object_set_class(PyObject *self, PyObject *value, void *closure)
{
	...
	PyTypeObject *new_, *newbase, *oldbase;
	...
	if (new_->tp_flags & Py_TPFLAGS_HEAPTYPE) 
	{
		Py_INCREF(new_);
	}
	self->ob_type = new_;
...
static PyObject *object_reduce(PyObject *self, PyObject *args)
{
...
static int add_subclass(PyTypeObject *base, PyTypeObject *type)
{
	...
	new_ = PyWeakref_NewRef((PyObject *)type, NULL);
	...
	while (--i >= 0) 
	{
		...
		{
			return PyList_SetItem(list, i, new_);
		}
	}
	i = PyList_Append(list, new_);
	Py_DECREF(new_);
	return i;
}

static PyObject *wrap_inquiry(PyObject *self, PyObject *args, void *wrapped)
{
...
static PyObject *wrap_coercefunc(PyObject *self, PyObject *args, void *wrapped)
{
...
static PyObject *wrap_ternaryfunc(PyObject *self, PyObject *args, void *wrapped)
{
...
static PyObject *wrap_ternaryfunc_r(PyObject *self, PyObject *args, void *wrapped)
{
	ternaryfunc func = (ternaryfunc)wrapped;
	PyObject *other;
	PyObject *third = Py_None;
...
static PyObject *wrap_intargfunc(PyObject *self, PyObject *args, void *wrapped)
{
...
static int getindex(PyObject *self, PyObject *arg)
{
	int i;
...
static PyObject *wrap_sq_item(PyObject *self, PyObject *args, void *wrapped)
{
	intargfunc func = (intargfunc)wrapped;
	PyObject *arg;
	int i;
...
static PyObject *wrap_intintargfunc(PyObject *self, PyObject *args, void *wrapped)
{
...
static PyObject *wrap_intintobjargproc(PyObject *self, PyObject *args, void *wrapped)
{
...
static PyObject *wrap_cmpfunc(PyObject *self, PyObject *args, void *wrapped)
{
...
static PyObject *wrap_descr_get(PyObject *self, PyObject *args, void *wrapped)
{
...
static PyObject *wrap_init(PyObject *self, PyObject *args, void *wrapped, PyObject *kwds)
{
...
static PyObject *wrap_descr_delete(PyObject *self, PyObject *args, void *wrapped)
{
	descrsetfunc func = (descrsetfunc)wrapped;
	PyObject *obj;
	int ret;
...
static PyObject *tp_new_wrapper(PyObject *self, PyObject *args, PyObject *kwds)
{
...
static int slot_sq_length(PyObject *self)
{
...
static PyObject *slot_sq_item(PyObject *self, int i)
{
...
static int slot_sq_ass_item(PyObject *self, int index, PyObject *value)
{
	PyObject *res;
...
static int slot_sq_ass_slice(PyObject *self, int i, int j, PyObject *value)
{
	PyObject *res;
...
static int slot_nb_nonzero(PyObject *self)
{
	PyObject *func, *res;
...
static int half_compare(PyObject *self, PyObject *other)
{
...
static long slot_tp_hash(PyObject *self)
{
	PyObject *func, *res;
...
static PyObject *slot_tp_call(PyObject *self, PyObject *args, PyObject *kwds)
{
...
static PyObject *slot_tp_iter(PyObject *self)
{
	PyObject *func, *res;
...
static PyObject *slot_tp_iternext(PyObject *self)
{
	static PyObject *next_str;
	return call_method(self, "next", &next_str, "()");
}

static PyObject *slot_tp_descr_get(PyObject *self, PyObject *obj, PyObject *type)
{
	PyTypeObject *tp = self->ob_type;
	PyObject *get;
...
static PyObject *slot_tp_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
...
static int update_these_slots(PyTypeObject *type, slotdef **pp0, PyObject *name)
{
	slotdef **pp;
...
static int recurse_down_subclasses(PyTypeObject *type, slotdef **pp, PyObject *name)
{
...
static int supercheck(PyTypeObject *type, PyObject *obj)
{
	if (!PyType_IsSubtype(obj->ob_type, type) &&
	    !(PyType_Check(obj) &&
...
static PyObject *super_descr_get(PyObject *self, PyObject *obj, PyObject *type)
{
	...
	else 
	{
		...
		new_ = (superobject *)PySuper_Type.tp_new(&PySuper_Type,
							 NULL, NULL);
		if (new_ == NULL)
		{
			return NULL;
